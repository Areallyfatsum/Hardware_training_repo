...
module design_1
  ...
  wire axi_bram_ctrl_a1_bram_en_a;
  wire [31:0]axi_bram_ctrl_a1_bram_wrdata_a;
  wire [12:0]axi_bram_ctrl_a_bram_addr_a;
  wire axi_bram_ctrl_a_bram_en_a;
  wire [31:0]axi_bram_ctrl_a_bram_wrdata_a;
  wire [12:0]axi_bram_ctrl_b_bram_addr_a;
  wire [12:0]axi_bram_ctrl_s_bram_addr_a;
  wire axi_bram_ctrl_s_bram_en_a;
  ...
  design_1_axi_bram_ctrl_a_0 axi_bram_ctrl_a
       (.bram_addr_a(axi_bram_ctrl_a_bram_addr_a),
        .bram_en_a(axi_bram_ctrl_a_bram_en_a),
        ...
        .bram_wrdata_a(axi_bram_ctrl_a_bram_wrdata_a),
  ...
  design_1_axi_bram_ctrl_b_0 axi_bram_ctrl_b
       (.bram_addr_a(axi_bram_ctrl_b_bram_addr_a),
        .bram_en_a(axi_bram_ctrl_a1_bram_en_a),
        .bram_rddata_a({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b1,1'b0,1'b0,1'b0}),
        .bram_wrdata_a(axi_bram_ctrl_a1_bram_wrdata_a),
        .s_axi_aclk(zynq_ultra_ps_e_0_pl_clk0),
  ...
  design_1_axi_bram_ctrl_s_0 axi_bram_ctrl_s
       (.bram_addr_a(axi_bram_ctrl_s_bram_addr_a),
        .bram_en_a(axi_bram_ctrl_s_bram_en_a),
        .bram_rddata_a(vadd_0_dos),
        .s_axi_aclk(zynq_ultra_ps_e_0_pl_clk0),
  ...
  design_1_vadd_0_0 vadd_0
       (.addra(xlslice_0_Dout),
        .addrb(xlslice_1_Dout),
        .addrs(xlslice_2_Dout),
        .clk(zynq_ultra_ps_e_0_pl_clk0),
        .dia(axi_bram_ctrl_a_bram_wrdata_a),
        .dib(axi_bram_ctrl_a1_bram_wrdata_a),
        .dos(vadd_0_dos),
        .ena(axi_bram_ctrl_a_bram_en_a),
        .enb(axi_bram_ctrl_a1_bram_en_a),
        .ens(axi_bram_ctrl_s_bram_en_a),
        .start(axi_gpio_0_gpio_io_o));
  design_1_xlslice_0_0 xlslice_0
       (.Din(axi_bram_ctrl_a_bram_addr_a),
        .Dout(xlslice_0_Dout));
  design_1_xlslice_1_0 xlslice_1
       (.Din(axi_bram_ctrl_b_bram_addr_a),
        .Dout(xlslice_1_Dout));
  design_1_xlslice_2_0 xlslice_2
       (.Din(axi_bram_ctrl_s_bram_addr_a),
        .Dout(xlslice_2_Dout));
