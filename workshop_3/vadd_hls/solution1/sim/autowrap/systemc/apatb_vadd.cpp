...
// wrapc file define:
#define AUTOTB_TVIN_a "../tv/cdatafile/c.vadd.autotvin_a.dat"
#define AUTOTB_TVOUT_a "../tv/cdatafile/c.vadd.autotvout_a.dat"
#define AUTOTB_TVIN_b "../tv/cdatafile/c.vadd.autotvin_b.dat"
#define AUTOTB_TVOUT_b "../tv/cdatafile/c.vadd.autotvout_b.dat"
#define AUTOTB_TVIN_s "../tv/cdatafile/c.vadd.autotvin_s.dat"
#define AUTOTB_TVOUT_s "../tv/cdatafile/c.vadd.autotvout_s.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_s "../tv/rtldatafile/rtl.vadd.autotvout_s.dat"
...
extern "C"
void vadd_hw_stub_wrapper(void*, void*, void*);

extern "C"
void apatb_vadd_hw(void* __xlx_apatb_param_a, void* __xlx_apatb_param_b, void* __xlx_apatb_param_s)
{
#ifdef USE_BINARY_TV_FILE
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_s),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_s),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_s),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_s),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_s),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_s),
#endif
#endif
  };
  port2.param = { __xlx_apatb_param_s };
  port2.nbytes = { 400 };
  port2.offset = {  };
  port2.hasWrite = { true };
  ...
  try {
    ...
    vadd_hw_stub_wrapper(__xlx_apatb_param_a, __xlx_apatb_param_b, __xlx_apatb_param_s);
