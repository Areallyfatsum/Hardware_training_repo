...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "vadd.autotvin.dat"
	set constFileTvOut       "vadd.autotvout.dat"
	set constFileHdlTvIn     "vadd.autohdltvin.dat"
	set constFileHdlTvOut    "vadd.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
