...
$(ObjDir)/vadd_tb.cpp_pre.cpp.tb.o : vadd_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling vadd_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/vadd.cpp_pre.cpp.tb.o : vadd.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling vadd.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
