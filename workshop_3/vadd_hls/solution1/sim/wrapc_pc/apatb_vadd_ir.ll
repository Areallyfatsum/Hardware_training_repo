...
define void @apatb_vadd_ir(i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="100" %a, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="100" %b, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="100" %s) local_unnamed_addr #0 {
entry:
