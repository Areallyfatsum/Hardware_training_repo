...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "a","offset": { "type": "dynamic","port_name": "a","bundle": "control"},"direction": "READONLY"},{"cName": "b","offset": { "type": "dynamic","port_name": "b","bundle": "control"},"direction": "READONLY"},{"cName": "s","offset": { "type": "dynamic","port_name": "s","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "1307", "EstimateLatencyMax" : "1307",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set ArgLastReadFirstWriteLatency {
	vadd {
		gmem {Type IO LastRead 12 FirstWrite 14}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1307", "Max" : "1307"}
	, {"Name" : "Interval", "Min" : "1308", "Max" : "1308"}
]}
