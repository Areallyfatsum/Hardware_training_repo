; ModuleID = 'C:/Users/musta/OneDrive/Documents/GitHub/Hardware_training_repo/workshop_3/vadd_hls/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: inaccessiblemem_or_argmemonly noinline
define void @apatb_vadd_ir(i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="100" "maxi" %a, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="100" "maxi" %b, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="100" "maxi" %s) local_unnamed_addr #0 {
entry:
  %a_copy = alloca [100 x i32], align 512
  %b_copy = alloca [100 x i32], align 512
  %s_copy = alloca [100 x i32], align 512
  %0 = bitcast i32* %a to [100 x i32]*
  %1 = bitcast i32* %b to [100 x i32]*
  %2 = bitcast i32* %s to [100 x i32]*
  call fastcc void @copy_in([100 x i32]* nonnull %0, [100 x i32]* nonnull align 512 %a_copy, [100 x i32]* nonnull %1, [100 x i32]* nonnull align 512 %b_copy, [100 x i32]* nonnull %2, [100 x i32]* nonnull align 512 %s_copy)
  call void @apatb_vadd_hw([100 x i32]* %a_copy, [100 x i32]* %b_copy, [100 x i32]* %s_copy)
  call void @copy_back([100 x i32]* %0, [100 x i32]* %a_copy, [100 x i32]* %1, [100 x i32]* %b_copy, [100 x i32]* %2, [100 x i32]* %s_copy)
  ret void
}
...
declare void @apatb_vadd_hw([100 x i32]*, [100 x i32]*, [100 x i32]*)
...
define void @vadd_hw_stub_wrapper([100 x i32]*, [100 x i32]*, [100 x i32]*) #5 {
entry:
  call void @copy_out([100 x i32]* null, [100 x i32]* %0, [100 x i32]* null, [100 x i32]* %1, [100 x i32]* null, [100 x i32]* %2)
  %3 = bitcast [100 x i32]* %0 to i32*
  %4 = bitcast [100 x i32]* %1 to i32*
  %5 = bitcast [100 x i32]* %2 to i32*
  call void @vadd_hw_stub(i32* %3, i32* %4, i32* %5)
  call void @copy_in([100 x i32]* null, [100 x i32]* %0, [100 x i32]* null, [100 x i32]* %1, [100 x i32]* null, [100 x i32]* %2)
  ret void
}

declare void @vadd_hw_stub(i32*, i32*, i32*)
