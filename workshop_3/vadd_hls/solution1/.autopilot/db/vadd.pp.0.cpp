...
# 2 "<built-in>" 2
# 1 "vadd_hls/vadd.cpp" 2

# 1 "vadd_hls/vadd.h" 1



__attribute__((sdx_kernel("vadd", 0))) void vadd(int a[100], int b[100], int s[100]);
# 3 "vadd_hls/vadd.cpp" 2

__attribute__((sdx_kernel("vadd", 0))) void vadd(int a[100], int b[100], int s[100]) {
#line 17 "C:/Users/musta/OneDrive/Documents/GitHub/Hardware_training_repo/workshop_3/vadd_hls/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=vadd
# 4 "vadd_hls/vadd.cpp"
...
#pragma HLS INTERFACE s_axilite port=return
 ...
 VITIS_LOOP_10_1: for (int i=0; i<100; i++) {
