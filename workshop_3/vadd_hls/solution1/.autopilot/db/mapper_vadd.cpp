...
using hls::sim::Byte;
extern "C" void vadd(Byte<4>*, int, int, int);
extern "C" void apatb_vadd_hw(volatile void * __xlx_apatb_param_a, volatile void * __xlx_apatb_param_b, volatile void * __xlx_apatb_param_s) {
using hls::sim::createStream;
  // Collect __xlx_a_b_s__tmp_vec
std::vector<Byte<4>> __xlx_a_b_s__tmp_vec;
for (size_t i = 0; i < 100; ++i){
__xlx_a_b_s__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_a)[i]);
}
  int __xlx_size_param_a = 100;
  int __xlx_offset_param_a = 0;
  int __xlx_offset_byte_param_a = 0*4;
for (size_t i = 0; i < 100; ++i){
__xlx_a_b_s__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_b)[i]);
}
  int __xlx_size_param_b = 100;
  int __xlx_offset_param_b = 100;
  int __xlx_offset_byte_param_b = 100*4;
for (size_t i = 0; i < 100; ++i){
__xlx_a_b_s__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_s)[i]);
}
  int __xlx_size_param_s = 100;
  int __xlx_offset_param_s = 200;
  int __xlx_offset_byte_param_s = 200*4;
  // DUT call
  vadd(__xlx_a_b_s__tmp_vec.data(), __xlx_offset_byte_param_a, __xlx_offset_byte_param_b, __xlx_offset_byte_param_s);
// print __xlx_apatb_param_a
for (size_t i = 0; i < __xlx_size_param_a; ++i) {
((Byte<4>*)__xlx_apatb_param_a)[i] = __xlx_a_b_s__tmp_vec[__xlx_offset_param_a+i];
}
// print __xlx_apatb_param_b
for (size_t i = 0; i < __xlx_size_param_b; ++i) {
((Byte<4>*)__xlx_apatb_param_b)[i] = __xlx_a_b_s__tmp_vec[__xlx_offset_param_b+i];
}
// print __xlx_apatb_param_s
for (size_t i = 0; i < __xlx_size_param_s; ++i) {
((Byte<4>*)__xlx_apatb_param_s)[i] = __xlx_a_b_s__tmp_vec[__xlx_offset_param_s+i];
}
}
